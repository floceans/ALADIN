...
for iyear in range(yearmin,yearmax):
    ...
    sstf1 = 'ts_DOM12_CNRM-CM6-1-HR_amip_r1i1p1f2_CNRM_CNRM-ALADIN63_v1_6hrPt_{0}01010600-{1}07010000.nc'.format(iyear,iyear)
    sstf2 = 'ts_DOM12_CNRM-CM6-1-HR_amip_r1i1p1f2_CNRM_CNRM-ALADIN63_v1_6hrPt_{0}07010600-{1}01010000.nc'.format(iyear,iyear+1)
#   fin2 = 'suiANTILLE_{0}-{1}.vor5_res17_1_-2_5.rel200'.format(iyear,iyear+1)
    ...
    fsst2 = nc.Dataset(os.path.join(dirdat,sstf2))
    lines1 = f1.readlines()
    sst1=fsst1.variables['ts'][:].data
    lon=fsst1.variables['lon'][180,:].data
    lat=fsst1.variables['lat'][:,240].data
    sst2=fsst1.variables['ts'][:].data
