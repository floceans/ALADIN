...
track_path = '/home/florent/Documents/ENM_3A/Aladin/REL200/F10_10ans/'
...
for iyear in range(yearmin,yearmax):
    print(iyear)
    yp1=iyear+1
    fin = track_path+'/sui{0}_{1}-{2}.vor5_res17_1_-2_5.rel200'.format(domain,iyear,yp1)
    f = open(os.path.join(track_path,fin))
    lines = f.readlines()
    print(fin)
    f.close()
